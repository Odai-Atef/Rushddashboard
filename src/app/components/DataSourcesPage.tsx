...
export function DataSourcesPage() {
 ...
 <Database className="w-8 h-8 text-[var(--secondary)]" />
 </div>
 </div>
 ...
 <p className="text-2xl mt-1 text-[var(--primary)]">{stats.connected}</p>
 </div>
 ...
 <p className="text-2xl mt-1 text-[var(--secondary)]">{stats.syncing}</p>
 </div>
 <RefreshCw className="w-8 h-8 text-[var(--secondary)]" />
 </div>
 </div>
 ...
 {showAddModal && (
 <>
 <div className="fixed inset-0 bg-[var(--text-primary)]/[0.5] z-40" onClick={() => setShowAddModal(false)} />
 ...
 {selectedSource && (
 <>
 <div className="fixed inset-0 bg-[var(--text-primary)]/[0.5] z-40" onClick={() => setSelectedSource(null)} />
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
