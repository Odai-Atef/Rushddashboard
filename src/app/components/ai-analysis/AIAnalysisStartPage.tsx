...
export function AIAnalysisStartPage() {
 ...
 className="px-4 py-3 bg-[var(--card)] border border-border text-foreground rounded-lg hover:bg-muted transition-all flex items-center gap-[var(--spacing-small-gap)] shadow-sm"
 >
