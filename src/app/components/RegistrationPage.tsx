...
export function RegistrationPage() {
 ...
 {errors.fullName && <p className="text-xs text-[var(--destructive)] mt-1">{errors.fullName}</p>}
 </div>
 ...
 {errors.phone && <p className="text-xs text-[var(--destructive)] mt-1">{errors.phone}</p>}
 </div>
 ...
 {errors.companyName && <p className="text-xs text-[var(--destructive)] mt-1">{errors.companyName}</p>}
 </div>
 ...
 {errors.confirmPassword && <p className="text-xs text-[var(--destructive)] mt-1">{errors.confirmPassword}</p>}
 </div>
 ...
 {errors.agreeToTerms && <p className="text-xs text-[var(--destructive)] mt-1">{errors.agreeToTerms}</p>}
 </div>
