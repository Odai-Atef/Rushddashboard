...
export function AIProjectInnovationModule() {
 ...
 <Target className="w-8 h-8 text-[var(--primary-foreground)]" />
 </div>
 ...
 opp.priority === 'high' ? 'text-[var(--destructive)]' :
 opp.priority === 'medium' ? 'text-[var(--warning)]' :
 'text-[var(--secondary)]'
 }`} />
 ...
 <span className="text-sm font-medium text-[var(--secondary)]">{Math.round(progress)}%</span>
 </div>
 ...
 <div>
 <p className="font-semibold text-[var(--primary)]/[0.9]">جودة عالية</p>
 <p className="text-sm text-[var(--primary)]">الذكاء الاصطناعي واثق بنسبة 92% من جودة هذا المشروع</p>
 </div>
 </div>
 </div>
 ...
 <button className="px-6 py-3 bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:bg-[var(--primary)]/90 transition-colors font-medium">
 اختر ملف
 </button>
 </div>
 ...
 <h3 className="font-semibold text-[var(--primary)]/[0.9] mb-4">ملخص التحسينات</h3>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 <div className="bg-card rounded-lg p-4">
 <CheckCircle2 className="w-6 h-6 text-[var(--primary)] mb-2" />
 ...
 <p className="text-[var(--primary)]/[0.4]">جاهز للموافقة</p>
 </div>
 ...
 <span className="text-sm font-bold text-[var(--secondary)]">{item.score}%</span>
 </div>
 <div className="h-2 bg-muted rounded-full overflow-hidden">
 <div
