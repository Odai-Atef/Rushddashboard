...
export function Sidebar({ activeView, className }: SidebarProps) {
 ...
 >
 {/* Logo */}
 <div className="p-4 border-b border-[var(--primary-foreground)]/[0.1] text-center relative">
 <img
 src="/logo.png"
 alt="منصة رشد"
 className={cn(
 ...
 />
 {!isCollapsed && (
 <p className="text-[var(--primary-foreground)]/70 text-sm mt-2 font-medium tracking-wide">منصة رشد</p>
 )}
 ...
 {/* Footer */}
 <div className="p-4 border-t border-[var(--primary-foreground)]/[0.1]">
 {!isCollapsed ? (
 <p className="text-[var(--primary-foreground)]/40 text-xs text-center">© 2026 منصة رشد</p>
 ) : (
 <div className="flex justify-center">
 <div className="w-7 h-7 rounded-full bg-[var(--card)]/10 flex items-center justify-center text-xs text-[var(--primary-foreground)]/60 font-medium">
 ر
 </div>
 </div>
 )}
