...
export function LoginPage() {
 ...
 {justRegistered && (
 <div className="mb-6 p-4 bg-[var(--primary)]/[0.1] border border-[var(--primary)]/[0.2] rounded-lg">
 ...
 role="alert"
 aria-live="polite"
 className="mb-6 p-4 bg-[var(--primary)]/[0.1] border border-[var(--primary)]/[0.2] rounded-lg"
 >
 <p className="text-sm text-[var(--primary)]">
 ...
 role="alert"
 aria-live="polite"
 className="mb-6 p-4 bg-[var(--destructive)]/10 border border-red-500/20 rounded-lg"
 >
 ...
 <p className="text-sm text-[var(--primary-foreground)]/80">محلل تنفيذي ذكي يجيب على أسئلتك المعقدة</p>
 </div>
 </div>
 ...
 <p className="text-sm text-[var(--primary-foreground)]/80">تتبع المبيعات والعمليات والأداء في الوقت الفعلي</p>
 </div>
 </div>
 ...
 <p className="text-sm text-[var(--primary-foreground)]/80">اقتراحات عملية لتحسين الأداء والربحية</p>
 </div>
 </div>
 ...
 <p className="text-sm text-[var(--primary-foreground)]/80">رؤى عميقة ومؤشرات أداء رئيسية</p>
 </div>
 </div>
 </div>
 </div>
