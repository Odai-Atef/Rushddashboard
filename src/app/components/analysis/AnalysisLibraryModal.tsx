...
export function AnalysisLibraryModal({
 ...
 return (
 <div className="fixed inset-0 bg-[var(--text-primary)]/[0.5] z-50 flex items-center justify-center p-4">
 ...
 className="absolute left-4 top-1/2 -translate-y-1/2 p-1 hover:bg-accent rounded-lg"
 >
 <X className="w-4 h-4" />
 </button>
 )}
 ...
 {cat.nameAr || cat.name}
 {cat.count > 0 && (
 <span className="mr-2 px-2 py-0.5 bg-[var(--text-primary)]/[0.1] rounded-full text-xs">
 {cat.count}
 </span>
 )}
 </button>
