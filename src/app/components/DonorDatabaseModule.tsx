  ...
  const DirectoryView = () => {
    ...
    const getDonorTypeColor = (type: string) => {
      const colors: Record<string, string> = {
        'international': 'bg-blue-100 text-primary/80',
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`p-2 rounded-lg ${directoryView === 'table' ? 'bg-blue-600 text-white' : 'bg-muted'}`}
              >
                <List className="w-5 h-5" />
              </button>
              <button
                onClick={() => setDirectoryView('card')}
                className={`p-2 rounded-lg ${directoryView === 'card' ? 'bg-blue-600 text-white' : 'bg-muted'}`}
              >
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="flex gap-3">
                {donor.socialMedia.twitter && (
                  <a href={`https://twitter.com/${donor.socialMedia.twitter}`} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-50 rounded-lg hover:bg-primary/20">
                    <Twitter className="w-5 h-5 text-primary" />
                  </a>
                )}
                {donor.socialMedia.linkedin && (
                  <a href={`https://linkedin.com/company/${donor.socialMedia.linkedin}`} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-50 rounded-lg hover:bg-primary/20">
                    <Linkedin className="w-5 h-5 text-primary" />
                  </a>
                )}
                {donor.socialMedia.facebook && (
                  <a href={`https://facebook.com/${donor.socialMedia.facebook}`} target="_blank" rel="noopener noreferrer" className="p-3 bg-blue-50 rounded-lg hover:bg-primary/20">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="flex flex-wrap gap-2">
                {donor.fundingAreas.map((area, idx) => (
                  <span key={idx} className="px-4 py-2 bg-blue-100 text-primary/80 rounded-lg font-medium">
                    {area}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {donorOpportunities.filter(o => o.status === 'open' || o.status === 'closing-soon').map((opp) => (
                  <button
                    ...
                    className="w-full text-right p-3 bg-secondary rounded-lg hover:bg-blue-50 transition-colors"
                  >
  ...
  const OpportunitiesView = () => {
    ...
    const getEligibilityColor = (status: string) => {
      const colors: Record<string, string> = {
        ...
        'needs-review': 'bg-blue-100 text-primary/80'
      };
      return colors[status] || 'bg-muted text-foreground';
    };
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-card rounded-xl p-6 border border-yellow-200">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`p-2 rounded-lg ${opportunityView === 'list' ? 'bg-blue-600 text-white' : 'bg-muted'}`}
              >
                <List className="w-5 h-5" />
              </button>
              <button
                onClick={() => setOpportunityView('calendar')}
                className={`p-2 rounded-lg ${opportunityView === 'calendar' ? 'bg-blue-600 text-white' : 'bg-muted'}`}
              >
                <CalendarDays className="w-5 h-5" />
              </button>
              <button
                onClick={() => setOpportunityView('timeline')}
                className={`p-2 rounded-lg ${opportunityView === 'timeline' ? 'bg-blue-600 text-white' : 'bg-muted'}`}
              >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full px-4 py-2 border-2 border-dashed border-border rounded-lg hover:border-blue-500 hover:bg-blue-50 text-muted-foreground hover:text-primary transition-colors">
                  + إضافة ملاحظة جديدة
                </button>
              </div>
            </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="bg-card rounded-xl p-6 border border-purple-200">
          ...
          {alerts.map((alert) => (
            <div
              ...
              className={`bg-card rounded-xl p-6 border ${
                !alert.read ? 'border-blue-200 shadow-md' : 'border-border'
              } hover:shadow-lg transition-shadow`}
            >
              <div className="flex items-start gap-4">
                <div className={`p-3 rounded-full ${!alert.read ? 'bg-blue-50' : 'bg-secondary'}`}>
