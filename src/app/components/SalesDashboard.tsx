...
export function SalesDashboard() {
 ...
 <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">لوحة المبيعات</h2>
 <p className="text-muted-foreground text-base">نظرة شاملة على أداء المبيعات والإيرادات</p>
 </div>
 ...
 <td className="px-6 py-4">
 <div className={`flex items-center gap-1 ${product.growth >= 0 ? 'text-[var(--primary)]' : 'text-[var(--destructive)]'}`}>
