...
export function SalesDashboard() {
 ...
 <h2 className="text-3xl md:text-4xl font-bold text-[var(--text-primary)] mb-2">لوحة المبيعات</h2>
 <p className="text-[var(--text-muted)] text-base">نظرة شاملة على أداء المبيعات والإيرادات</p>
 </div>
 ...
 const Icon = kpi.icon;
 return (
 <div key={index} className="bg-[var(--card)] rounded-[var(--radius-card)] border border-[var(--border)] p-[var(--spacing-card-padding)] shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-lg)] dark:hover:shadow-lg transition-all duration-200">
 ...
 تحليل البيانات يُظهر أن <span className="text-[var(--text-primary)] font-medium">منطقة الرياض</span> تحقق أعلى إيرادات بنسبة 38% من الإجمالي.
 المنتجات الاستشارية شهدت نمواً بنسبة <span className="text-[var(--primary)] font-medium">+15.3%</span> خلال الشهر الماضي.
 معدل التحويل تحسن بشكل ملحوظ بفضل <span className="text-[var(--text-primary)] font-medium">تحسينات تجربة المستخدم</span> التي تم تطبيقها في الربع الأخير.
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="text-sm text-[var(--text-muted)]">مقارنة الإيرادات الفعلية بالمستهدفة</p>
 </div>
 ...
 <p className="text-sm text-[var(--text-muted)]">مبيعات الفروع حسب المنطقة</p>
 </div>
 <ResponsiveContainer width="100%" height={300}>
 ...
 <p className="text-sm text-[var(--text-muted)]">أفضل 5 منتجات من حيث الإيرادات</p>
 </div>
 ...
 <th className="px-6 py-4 text-right text-sm font-medium text-[var(--text-muted)]">المبيعات</th>
 <th className="px-6 py-4 text-right text-sm font-medium text-[var(--text-muted)]">الوحدات المباعة</th>
 <th className="px-6 py-4 text-right text-sm font-medium text-[var(--text-muted)]">النمو</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
 {topProducts.map((product) => (
 <tr key={product.id} className="hover:bg-secondary/50 transition-colors">
 <td className="px-6 py-4 text-sm text-[var(--text-muted)]">{product.id}</td>
 ...
 <td className="px-6 py-4">
 <div className={`flex items-center gap-[var(--spacing-small-gap)] ${product.growth >= 0 ? 'text-[var(--primary)]' : 'text-[var(--destructive)]'}`}>
 ...
 <span className="px-2 py-1 bg-[var(--primary)]/[0.2] text-[var(--primary)] text-xs rounded-full">عاجل</span>
 </div>
 <p className="text-[var(--text-muted)] leading-relaxed mb-[var(--spacing-section-gap)]">
 نوصي بزيادة الاستثمار في <span className="text-[var(--text-primary)] font-medium">فرع الرياض</span> بنسبة 20% والتركيز على
 <span className="text-[var(--text-primary)] font-medium"> المنتجات الاستشارية</span> التي تحقق أعلى معدل نمو.
 من المتوقع أن يؤدي ذلك إلى زيادة الإيرادات بنسبة <span className="text-[var(--primary)] font-medium">+28%</span> في الربع القادم.
 </p>
