...
export function TopBar({
 ...
 isDark ? 'text-[var(--primary-foreground)]/50' : 'text-[var(--text-muted)]'
 )}
 />
 <input
 type="text"
 ...
 isDark ? 'text-[var(--primary-foreground)]/40 hover:text-[var(--primary-foreground)]' : 'text-[var(--text-muted)] hover:text-[var(--text-primary)]'
 )}
 ...
 {unreadCount > 0 && (
 <span className="absolute top-1 right-1 min-w-[18px] h-[18px] bg-[var(--danger)] rounded-[var(--radius-badge)] text-xs text-[var(--primary-foreground)] flex items-center justify-center font-bold px-1 shadow-sm">
 ...
 : 'bg-[var(--destructive)]/[0.08] text-[var(--danger)]'
 )}
 >
 ...
 isDark ? 'text-[var(--primary-foreground)]/40' : 'text-[var(--text-muted)]'
 )}
 />
 </div>
 ...
 isDark ? 'text-[var(--primary-foreground)]' : 'text-[var(--text-muted)]'
 )}
 />
 <p className={cn('text-sm', isDark ? 'text-[var(--primary-foreground)]/50' : 'text-[var(--text-muted)]')}>
 لا توجد إشعارات
 </p>
 </div>
 ) : (
 ...
 <p className="text-sm truncate text-[var(--text-muted)]/50">
 {user?.email ?? ''}
 </p>
 </div>
 ...
 className={cn(
 'h-px my-2',
 isDark ? 'bg-[var(--card)]/10' : 'bg-[var(--border)]'
 )}
 />
