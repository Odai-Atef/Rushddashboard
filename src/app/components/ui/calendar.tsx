...
function Calendar({
 ...
 "size-8 p-0 font-normal text-[var(--text-primary)] aria-selected:opacity-100 hover:bg-[var(--hover)]",
 ),
 day_range_start:
 ...
 day_selected:
 "bg-[var(--primary)] text-[var(--primary-foreground)] hover:bg-[var(--primary)]/90 focus:bg-[var(--primary)] focus:text-[var(--primary-foreground)]",
 day_today: "bg-[var(--hover)] text-[var(--text-primary)]",
 day_outside:
