...
export function SettingsPage() {
 ...
 <span className="text-xs text-[var(--primary)] font-medium">الجلسة الحالية</span>
 </div>
 <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
 <div>
 ...
 <span className="text-xs bg-[var(--primary)]/10 text-[var(--secondary)] px-3 py-1 rounded-full">
 12 مستخدم
 </span>
 </div>
 <div className="grid grid-cols-3 gap-2 text-xs">
 ...
 <div className="w-12 h-12 rounded-lg bg-[var(--primary)] flex items-center justify-center text-[var(--primary-foreground)] font-bold">
 SB
 </div>
 <div>
 ...
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-lg bg-purple-500 flex items-center justify-center text-[var(--primary-foreground)] font-bold">
 ST
 </div>
 <div>
 ...
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-lg bg-[var(--destructive)] flex items-center justify-center text-[var(--primary-foreground)] font-bold">
 ZP
 </div>
 <div>
