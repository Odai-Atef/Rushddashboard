...
export function AIRecommendedDonors({
 ...
 <Loader2 className="w-10 h-10 animate-spin text-[var(--secondary)] mb-4" />
 ...
 {projectError && (
 <p className="text-sm text-[var(--destructive)] text-right">{projectError}</p>
 )}
 {project && (
 ...
 className="inline-flex items-center gap-1.5 px-4 py-2.5 text-sm bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:bg-[var(--primary)]/90 transition-colors flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 {/* Logo */}
 <div
 className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-[var(--primary-foreground)] text-lg flex-shrink-0 cursor-pointer hover:opacity-90 transition-opacity"
 ...
 {/* Actions */}
 <div className="flex items-center justify-start gap-2 flex-wrap mt-3 pt-3 border-t border-border">
 <a
 href={donor.url}
 target="_blank"
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:bg-[var(--primary)]/90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 onClick={() => handleGeneratePlan(donor.id, donor.name)}
 disabled={generatingId === donor.id}
 className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-violet-600 text-[var(--primary-foreground)] rounded-lg hover:bg-violet-700 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {generatingId === donor.id ? (
 <Loader2 className="w-3.5 h-3.5 animate-spin" />
 ) : (
