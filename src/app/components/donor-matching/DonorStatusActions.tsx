...
export function DonorStatusActions({ matchId, currentStatus, onStatusChange }: DonorStatusActionsProps) {
 ...
 disabled={isLoading}
 className="px-4 py-2 text-sm bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:bg-[var(--primary)]/90 transition-colors disabled:opacity-50 flex items-center gap-2"
 >
