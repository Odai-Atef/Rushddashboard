...
export function MatchAnalysis({ donorId, onNavigate }: MatchAnalysisProps) {
 ...
 <Brain className="w-4 h-4 text-[var(--secondary)]" />
 <span className="text-xs text-muted-foreground">تحليل الذكاء الاصطناعي</span>
 </div>
 <p className="text-sm text-foreground mb-3">
 هذا المانح <strong className="text-[var(--primary)]">مناسب جداً</strong> لمشروعك — التوافق في 5 أبعاد رئيسية يجعل هذه الفرصة من أعلى الأولويات للتقديم.
 </p>
 <div className="flex flex-wrap gap-4 justify-end">
 <div className="text-center">
 <p className="text-[var(--primary)]">{donor.successRate}%</p>
