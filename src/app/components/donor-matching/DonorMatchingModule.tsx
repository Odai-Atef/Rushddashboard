...
export function DonorMatchingModule() {
 ...
 <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-[var(--destructive)] rounded-full text-xs text-[var(--primary-foreground)] flex items-center justify-center">7</span>
 </div>
 </div>
