...
export function CharityAssessmentRoadmapPage() {
 ...
 className="px-6 py-3 bg-[var(--primary)] text-[var(--primary-foreground)] rounded-lg hover:bg-[var(--primary)]/90 transition-colors font-medium"
 >
 إعادة المحاولة
 </button>
 </div>
 ...
 >
 <span
 className={`text-2xl font-bold ${isQualified ? 'text-[var(--secondary)]' : 'text-[var(--destructive)]'}`}
 >
 ...
 isQualified ? 'bg-[var(--primary)]/[0.1] text-[var(--primary)]' : 'bg-[var(--destructive)]/[0.1] text-[var(--destructive)]'
 }`}
 >
