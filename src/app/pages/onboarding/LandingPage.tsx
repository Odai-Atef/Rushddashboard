...
export function LandingPage() {
 ...
 <div className="bg-[var(--card)] rounded-2xl p-6 shadow-sm border border-border/80/50 transition-all duration-200 hover:shadow-md flex flex-col justify-start h-full">
