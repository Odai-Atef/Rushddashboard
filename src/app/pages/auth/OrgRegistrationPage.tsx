...
export function OrgRegistrationPage() {
 ...
 {errors.orgName && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.orgName }} />}
 </div>
 ...
 {errors.orgType && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.orgType }} />}
 </div>
 ...
 {errors.fundingAreas && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.fundingAreas }} />}
 </div>
 )}
 ...
 {errors.activity && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.activity }} />}
 </div>
 )}
 ...
 />
 {errors.licenseNumber && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.licenseNumber }} />}
 </div>
 ...
 {errors.email && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.email }} />}
 </div>
 ...
 {errors.phone && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.phone }} />}
 </div>
 ...
 {errors.password && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.password }} />}
 </div>
 ...
 {errors.confirmPassword && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.confirmPassword }} />}
 </div>
 </div>
 ...
 {errors.agreeToTerms && <p className="text-xs text-[var(--destructive)] mt-1" dangerouslySetInnerHTML={{ __html: errors.agreeToTerms }} />}
 </div>
 ...
 <div className="relative z-10 max-w-md text-[var(--primary-foreground)]">
 <h2 className="text-3xl font-bold mb-4">
 انضم إلى أفضل المستثمرين
 <br />
 والتنفيذيين
 </h2>
 <p className="text-lg mb-6 text-[var(--primary-foreground)]/90">
