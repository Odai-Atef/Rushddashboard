...
export function PricingPage() {
 ...
 <div className="mb-10 p-5 bg-[var(--secondary)]/[0.08] border border-[var(--secondary)]/[0.3] rounded-xl text-right max-w-3xl mx-auto">
 ...
 {activeSubscription && (
 <div className="mb-8 p-4 rounded-xl bg-[var(--primary)]/[0.08] border border-green-200 text-[var(--primary)]/[0.8] flex items-start gap-3">
 ...
 {error && (
 <div className={`mb-8 p-4 rounded-xl flex items-start gap-3 ${notStartedStatus || requiredDocumentsMissing ? 'bg-[var(--warning)]/[0.08] border border-[var(--warning)]/[0.3] text-amber-800' : 'bg-[var(--destructive)]/[0.08] border border-[var(--destructive)]/[0.3] text-[var(--destructive)]'}`}>
 ...
 <button
 onClick={() => navigate('/dashboard/charity-assessment')}
 className="inline-flex items-center gap-2 px-4 py-2 bg-amber-600 text-[var(--primary-foreground)] rounded-lg hover:bg-amber-700 transition-colors text-sm font-medium"
 >
 ابدأ التقييم الآن
 ...
 {/* SLA / Terms Modal */}
 {slaModalOpen && (
 <div className="fixed inset-0 bg-[var(--text-primary)]/[0.5] flex items-center justify-center z-50 p-4" dir="rtl">
 ...
 {/* Terms Checkbox */}
 <div className="mt-6 p-4 bg-[var(--secondary)]/[0.08] rounded-xl border border-[var(--secondary)]/[0.2]">
