...
export function ProjectDashboardPage() {
 ...
 <p className="text-2xl sm:text-3xl font-bold text-foreground tracking-tight">{stats.total}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-[var(--secondary)] tracking-tight">{stats.active}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-muted-foreground tracking-tight">{stats.draft}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-[var(--warning)] tracking-tight">{stats.awaitingApproval}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-[var(--primary)] tracking-tight">{stats.approved}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-[var(--primary)] tracking-tight">{stats.funded}</p>
 </div>
 </div>
 ...
 <p className="text-2xl sm:text-3xl font-bold text-purple-600 tracking-tight">{stats.completed}</p>
 </div>
 </div>
 </div>
 ...
 className="text-sm text-[var(--primary)] hover:text-[var(--primary)] dark:hover:text-emerald-300"
 >
 عرض الكل
 </button>
 </div>
 ...
 <span className="font-medium text-[var(--secondary)]">{activity.projectName}</span>
 </p>
 ...
 <div className="text-muted-foreground text-center py-4">لا يوجد نشاط حديث</div>
 )}
 </div>
 </div>
 ...
 إشعارات تتطلب إجراء
 {unreadCount > 0 && (
 <span className="bg-[var(--destructive)]/[0.1] text-[var(--destructive)] text-xs font-bold px-2 py-0.5 rounded-full">
 {unreadCount}
 </span>
 )}
 </h3>
 ...
 <div className="text-muted-foreground text-center py-4">لا توجد إشعارات تتطلب إجراء</div>
 )}
 </div>
 </div>
 )}
 ...
 <div className="text-muted-foreground text-center py-4">لا توجد إشعارات</div>
 )}
 </div>
 </div>
 )}
