...
function DecisionFork({
 ...
 <div className="bg-[var(--primary)]/[0.08]/50 rounded-lg p-3 border border-[var(--primary)]/[0.2]">
 ...
 <div className="bg-[var(--destructive)]/[0.08]/50 rounded-lg p-3 border border-[var(--destructive)]/[0.2]">
 <p className="text-xs font-semibold text-[var(--destructive)] mb-2 flex items-center gap-1">
