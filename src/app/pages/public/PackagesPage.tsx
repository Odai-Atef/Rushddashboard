...
export function PackagesPage() {
 ...
 <div
 key={pkg.id}
 className="bg-[var(--card)] rounded-2xl p-7 border relative transition-all hover:shadow-lg flex flex-col h-full"
 style={{
 ...
 <Link
 to={`/sla/${pkg.id}`}
 className="w-full py-3.5 rounded-xl text-[var(--primary-foreground)] font-bold text-base mb-6 text-center transition-opacity hover:opacity-90 block"
 style={{ background: accent }}
 >
